...
let PayrollController = class PayrollController {
    ...
    async syncPayroll(body) {
        ...
        const initiatedBy = body.initiatedBy
            ? new mongoose_1.Types.ObjectId(body.initiatedBy)
            : undefined;
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('HR Manager', 'SYSTEM_ADMIN', 'Payroll Manager', 'Payroll Specialist'),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('HR Manager', 'SYSTEM_ADMIN', 'Payroll Manager', 'Payroll Specialist', 'HR_ADMIN'),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('HR Manager', 'SYSTEM_ADMIN', 'Payroll Manager'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
