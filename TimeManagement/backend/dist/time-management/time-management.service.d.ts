...
export declare class TimeManagementService {
    ...
    private readonly scheduleHelperService;
    private readonly repeatedLatenessService;
    private readonly permissionValidationService?;
    private readonly deviceSyncService?;
    constructor(attendanceModel: Model<AttendanceRecordDocument>, exceptionModel: Model<TimeExceptionDocument>, notificationModel: Model<NotificationLogDocument>, policyEngineService: PolicyEngineService, scheduleHelperService: ScheduleHelperService, repeatedLatenessService: RepeatedLatenessService, permissionValidationService?: PermissionValidationService | undefined, deviceSyncService?: DeviceSyncService | undefined);
    recordPunch(dto: CreatePunchDto, isOnline?: boolean): Promise<{
        message: string;
        queued: boolean;
        device: string;
    ...
    createTimeException(employeeId: string, recordId: string, reason: string, assignedToId: string, type?: TimeExceptionType, permissionType?: PermissionType, durationMinutes?: number, requestedDate?: Date): Promise<import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, TimeException, {}, {}> & TimeException & {
        _id: Types.ObjectId;
    } & {
        __v: number;
