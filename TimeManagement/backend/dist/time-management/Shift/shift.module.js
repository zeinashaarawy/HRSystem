...
const scheduling_rule_controller_1 = require("./controllers/scheduling-rule.controller");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: scheduling_rule_schema_1.SchedulingRule.name, schema: scheduling_rule_schema_1.SchedulingRuleSchema },
            ]),
        ],
        controllers: [
            ...
            scheduling_rule_controller_1.SchedulingRuleController,
        ],
        providers: [
            ...
            scheduling_rule_service_1.SchedulingRuleService,
