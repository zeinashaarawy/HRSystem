...
export declare class ScheduleAssignmentController {
    ...
    assign(createDto: CreateScheduleAssignmentDto, req: any): Promise<import("../schemas/schedule-assignment.schema").ScheduleAssignmentDocument>;
    ...
    renewAssignment(id: string, renewDto: RenewAssignmentDto): Promise<import("../schemas/schedule-assignment.schema").ScheduleAssignmentDocument>;
}
